                   ...
                   return   <div className='sideBySide '>
                       <div key={index} className='projectInfo bounce'>
                                ...
                                <div className='projectLinks'>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#8AE4F9" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="feather feather-github">
                                        <title>GitHub</title>
